def ticket_sale(
    ...
    buyer_count = 0  # Initialize buyer_count inside the function
    while total_tickets > 0:
        while True:  # Ensure the input is in the correct format and between 1-4
            try:
        ...
        if requested_tickets <= total_tickets:
            ...
            buyer_count += 1  # Accumulator for buyer_count
    ...
    print(f"All tickets sold! Total number of buyers: {buyer_count}")

# Call the function to run the ticket sale
ticket_sale()